...
{\noindent}By iterating (``rolling'') over the entire image space we produce the RHT output, $R(\theta,x,y)$. A visualization of the linear structures identified by the RHT, the backprojection $R(x,y)$, is obtained by integrating $R(\theta,x,y)$ over $\theta$:
