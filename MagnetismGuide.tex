...
{\noindent}\textbf{Sonic Mach number ($M_s$):} The sound speed of the \textit{interstellar medium} given by

\begin{align*}
    M_s = \left\langle\frac{\lvert\mathbf{v}\rvert}{c_s}\right\rangle ~ [{\rm dimensionless}].
\end{align*}
...
{\noindent}\textbf{Alfv\'en Mach number}: $M_A~[{\rm dimensionless}]$
...
\begin{align*}
    M_A = \left\langle\frac{\lvert\mathbf{v}\rvert}{v_A}\right\rangle ~ [{\rm dimensionless}]
\end{align*}

{\noindent}\textbf{Alfv\'en speed:}
\begin{align*}
    v_A = \frac{\lvert\mathbf{B}\lvert}{\sqrt{\rho}} ~ [{\rm m\,s^{-1}}]
\end{align*}
...
\begin{align*}
    \frac{\partial\mathbf{P}}{\partial s}_\mathrm{rad} = \sqrt{\frac{(Q\frac{\partial Q}{\partial x} + U\frac{\partial U}{\partial x})^2 + (Q\frac{\partial Q}{\partial y} + U\frac{\partial U}{\partial y})^2}{Q^2+U^2}}
\end{align*}
...
\begin{align*}
    \frac{\partial\mathbf{P}}{\partial s}_\mathrm{rad} = \sqrt{\frac{(Q\frac{\partial U}{\partial x} - U\frac{\partial Q}{\partial x})^2 + (Q\frac{\partial U}{\partial y} - U\frac{\partial Q}{\partial y})^2}{Q^2+U^2}}
\end{align*}
